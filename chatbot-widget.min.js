...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const intents = [
    ...
    {
      id: 'projects',
      patterns: ['project', 'build', 'built', 'created', 'made', 'thesis', 'library system', 'app', 'application', 'flutter', 'android studio', 'android app', 'mobile app', 'cybernate', 'drowsiness', 'drowsy'],
      handler: () => (
        ...
        "• AI Drowsiness Detection Project — a real-time computer vision system that monitors eye closure/yawning via webcam and alerts the driver/operator<br>" +
    ...
    {
      id: 'certifications',
      patterns: ['certification', 'cert', 'aws', 'comptia', 'wadhwani', 'huawei', 'badge', 'credential', 'machine learning foundations', 'ai course', 'itf', 'cloud practitioner', 'entrepreneurship', 'skilling', 'job ready'],
      handler: (data, q) => {
